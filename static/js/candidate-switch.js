$(function() {
  ...
  function loadBios(data) {
    ...
    clinton_data = {
      first_name: data.candidates[0].first_name,
      last_name: data.candidates[0].last_name,
      occupation: data.candidates[0].occupation,
      party: data.candidates[0].party,
      img: "clinton",
    ...
    sanders_data = {
      first_name: candidate_data[1].first_name,
      last_name: candidate_data[1].last_name,
      occupation: candidate_data[1].occupation,
      party: candidate_data[1].party,
      img: "sanders",
    ...
    trump_data = {
      first_name: candidate_data[2].first_name,
      last_name: candidate_data[2].last_name,
      occupation: candidate_data[2].occupation,
      party: candidate_data[2].party,
      img: "trump",
    ...
    cruz_data = {
      first_name: candidate_data[3].first_name,
      last_name: candidate_data[3].last_name,
      occupation: candidate_data[3].occupation,
      party: candidate_data[3].party,
      img: "cruz",
    ...
    kasich_data = {
      first_name: candidate_data[4].first_name,
      last_name: candidate_data[4].last_name,
      occupation: candidate_data[4].occupation,
      party: candidate_data[4].party,
      img: "kasich",
