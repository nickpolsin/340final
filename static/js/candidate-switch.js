$(function() {
  ...
  function loadBios(data) {
    ...
    sanders_data = {
      first_name: candidates[1].first_name,
      last_name: candidates[1].last_name,
      occupation: candidates[1].occupation,
    ...
    trump_data = {
      first_name: candidates[2].first_name,
      last_name: candidates[2].last_name,
      occupation: candidates[2].occupation,
      party: candidates[2].party,
      img: "trump",
    ...
    cruz_data = {
      first_name: candidates[3].first_name,
      last_name: candidates[3].last_name,
      occupation: candidates[3].occupation,
      party: candidates[3].party,
      img: "cruz",
    ...
    kasich_data = {
      first_name: candidates[4].first_name,
      last_name: candidates[4].last_name,
      occupation: candidates[4].occupation,
      party: candidates[4].party,
      img: "kasich",
